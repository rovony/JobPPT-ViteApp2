# Merck Deck App — Codex Instructions
...
> 2. **Read the workspace root `../../AGENTS.md` and `../../PROJECT-BRIEF.md`** —
...
User-invocable skill at `~/.Codex/skills/zaj-slides/`. Triggered by
...
When in conflict, **this file (merck-deck/AGENTS.md) wins for
...
Per workspace root `AGENTS.md`: every scientific claim in a slide
...
non-optional** (per global `~/.Codex/rules/frontend.md`). Recurring
...
## Workspace Conventions (from JobHunt2026 AGENTS.md)
