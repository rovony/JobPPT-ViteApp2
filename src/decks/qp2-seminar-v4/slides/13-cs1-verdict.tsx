 ...
 *
 * Phase A 2026-04-26: AUCss numerals are from Okour et al.; density curves
 * are illustrative Gaussians (qualitative overlap) — not digitized from the
 * paper. Subhead/caption state that to avoid implying a reproduced figure.
 *
  ...
  return (
    <SlideGrid dataCase="coral" areas={STANDARD_AREAS}>
      ...
      <Subhead delay={0.55} maxChars={94} size="lead">
        Geometric means per Okour 2023; overlap curves are illustrative.
        Same exposure match; dose range on the E-R plateau.
      </Subhead>
      ...
      <Viz>
        <div style={{
          ...
          >
            Illustrative AUCss densities · means per Okour 2023 · not extracted fig
          </motion.div>
        </div>
      </Viz>
