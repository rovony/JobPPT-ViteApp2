...
export default function PharmAgentApp() {
  ...
  return (
    <div className="min-h-screen min-w-[1200px] bg-stone-950 text-stone-100 flex flex-col">
      ...
      {/* MAIN GRID */}
      <div className="flex flex-1" style={{ height: 860 }}>
        <div className="flex-1 min-w-[800px] relative bg-stone-950">
      ...
      {/* FOOTER */}
      <div className="px-4 py-3 border-t border-stone-900 bg-stone-950 text-center">
        <span className="text-[12px] font-mono text-stone-600 tabular">
          Architecture grounded in Kim et al. arXiv:2512.08296 · centralized topology · 4.4× trace-level error containment
        </span>
      </div>
    </div>
  );
