 ...
 *   - Phase A 2026-04-26: Empirical record card — STARTS-1 primary was
 *     CPET peak VO₂ (not 6MWD); p=0.056 for combined dose groups vs
 *     placebo (Circulation 2011; N=235 randomized; FDA label aligns).
 *     6MWD feasibility called out separately in Endpoint row.
 */
...
const DRUG_FACTS = [
  ...
  { label: 'Indication', value: 'Adult PAH (WHO Group 1) · FDA Jun 2007 · EMA Apr 2008 · PMDA Jul 2010' },
...
const CONSTRAINTS = [
  ...
  { n: '05', label: 'Empirical record', value: 'STARTS-1 (N=235): prespecified CPET peak VO₂ primary p=0.056 vs placebo. 6MWD feasibility limits sit on top of that.' },
];

function FactCard({ items, headerKicker, headerColor, delay, reduced, isHero, numbered }) {
  return (
    <motion.div
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 0, minWidth: 0 }}>
              <span className="deck-mono uppercase" style={{
                ...
                color: numbered ? headerColor : 'var(--cream-faint)',
                letterSpacing: 'var(--ls-mono-wide)',
                fontWeight: 700,
              }}>
                {it.label}
    ...
    <SlideGrid dataCase="coral" areas={STANDARD_AREAS}>
      ...
      <Viz>
        ...
        {/* Closing reframe — the question shifted.
            ...
            for prose <24px; inline emphasis lifted to coral. */}
        <motion.div
        ...
        >
          The clinical question wasn&rsquo;t <em style={{ fontStyle: 'italic' }}>does it work in children?</em> &mdash; mechanism is conserved. The question was: <strong style={{ color: 'var(--case)', fontWeight: 600 }}>how do you defend a pediatric dose under these constraints?</strong>
        </motion.div>
      </Viz>
