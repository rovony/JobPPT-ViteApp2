...
const TIMELINE_EVENTS = [
  ...
  { year: '2001', era: 'firsts', label: 'bosentan · Tracleer',
    detail: 'First oral PAH therapy', tone: 'var(--cream)', badge: 'ET' },
  ...
  { year: '2013', era: 'thiscase', label: 'macitentan · Opsumit',
    detail: 'Tissue-targeted ERA', tone: 'var(--cream)', badge: 'ET' },
  ...
  { year: 'Mar 2024', era: 'merck', label: 'sotatercept · Winrevair',
    detail: 'Activin-signaling inhibitor', tone: 'var(--sage)', badge: 'BMPR2 · MERCK', highlight: true },
];
        ...
        <div style={{
          ...
          >
            ...
            <div style={{
              ...
              {[
                { era: 'SUPPORTIVE', tone: 'var(--cream-faint)' },
                { era: 'FIRSTS', tone: 'var(--cream)' },
                { era: 'EXPANSION', tone: 'var(--coral)' },
                { era: 'MERCK', tone: 'var(--sage)' },
              ].map((c) => (
                <div key={c.era} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              {PATHWAYS.map((p, i) => (
                <motion.div 
                  ...
                  style={{
                    ...
                    flexDirection: 'column',
                    gap: 'var(--space-2)',
                    boxShadow: (p.hero || p.merck) ? '0 4px 20px rgba(0,0,0,0.1)' : 'none',
                  }}
                >
                  ...
                  <div className="deck-body" style={{
                    fontSize: 'calc(var(--fs-slide-pageno) * 0.95)',
                    color: 'var(--cream)',
                    opacity: 0.7,
                    lineHeight: 1.4,
                    marginTop: 'auto',
...
function TimelineRow({ e, delay, go }) {
  return (
    <motion.div
      ...
      style={{
        display: 'grid',
        gridTemplateColumns: '5rem 10px 1fr auto',
        gap: 'var(--space-3)',
        alignItems: 'start',
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'center', height: '100%', paddingTop: 6 }}>
        <span style={{
      ...
      {e.badge && (
        <span className="deck-mono uppercase" style={{
          fontSize: 'calc(var(--fs-slide-pageno) * 0.8)',
          letterSpacing: 'var(--ls-mono-wide)',
          color: e.tone,
          padding: '2px 6px',
