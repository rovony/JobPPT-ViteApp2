 ...
 * cards anchored to Cmax / AUC / T½, presenter card + meta chip.
 *
 ...
 *
 * Each landmark dot carries a layoutId that pairs with the case-color
 * hairline on the corresponding CaseHeroDivider — when advancing from
 * the title directly into a divider, framer-motion morphs the dot's
 * bounding box into the divider's hairline.
 *
