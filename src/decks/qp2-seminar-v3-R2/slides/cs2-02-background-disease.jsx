 ...
 *
 * {{VERIFY: country count at Aug 2024 submission. R1 says "42+",
 *   consolidated R2R doesn't lock the figure. Need to fix the exact
 *   number before NumberTicker is wired.}}
 */

// ─── MAP POSITIONING (ported verbatim, do not change) ─────────────
// IndiaMap viewBox `55 -41 30 33` → world map `−180 −91.296 360 182.592`
//   left  = (55+180)/360 = 65.28%   top = (−41+91.296)/182.592 = 27.55%
//   width = 30/360 = 8.33%
const INDIA_DEST = {
  position: 'absolute',
  left:     '65.28%',
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* ── MAP ZONE (~60% canvas) — DO NOT TOUCH ── */}
          <div
            style={{
              position: 'relative',
              flex: '1 1 0%',
          ...
          >
            ...
            >
              ...
              <motion.div
                initial={{ filter: 'drop-shadow(0 0 0 rgba(125, 211, 252, 0))' }}
                animate={{
                  filter: [
                    'drop-shadow(0 0 0 rgba(125, 211, 252, 0))',
                    'drop-shadow(0 0 4px rgba(125, 211, 252, 0.42))',
                    'drop-shadow(0 0 0 rgba(125, 211, 252, 0))',
                  ],
                }}
                transition={{
              ...
              >
                <IndiaMap
                  ...
                  style={{ position: 'static', left: 'auto', top: 'auto', width: '100%' }}
                />
              </motion.div>
          ...
          >
            <p
              ...
              style={{
                margin: 0,
                fontSize: 'clamp(0.9rem, min(1.8vw, 2.8vh), 1.45rem)',
                fontStyle: 'italic',
                fontWeight: 600,
                lineHeight: 1.3,
                color: 'var(--cream)',
...
const TICKS = [
  ...
  { agency: 'CDSCO', year: 'Dec 2024', indication: 'R/R AML + CCA', accent: true },
];
          ...
          <React.Fragment key={t.agency}>
            ...
            >
              <span
                className="deck-mono uppercase"
                style={{
                  fontSize: 'clamp(0.6rem, min(1vw, 1.6vh), 0.82rem)',
                  letterSpacing: 'var(--ls-mono-wide)',
              ...
              <span
                className="deck-mono"
                style={{
                  fontSize: 'clamp(0.55rem, min(0.9vw, 1.4vh), 0.75rem)',
