    ...
    >
      <div
        style={{
          ...
          paddingTop: 'clamp(18px, 3.5vh, 52px)',
          paddingBottom: 'clamp(18px, 3.5vh, 52px)',
          minHeight: 0,
        }}
      >
        <FlowchartSVG />
      ...
      >
        ...
        <AnimFade delay={D.beforeLabel} reduced={r}>
          <text x="200" y="16"
            ...
            fill="#6e6a5e" letterSpacing="1.6" fontWeight="500">
        ...
        <g transform="translate(10, 87)">
          <AnimScale delay={D.start} reduced={r} cx={78} cy={30}>
            <rect x="0" y="0" width="155" height="60" rx="4"
              fill="#161719" stroke="#4a463e" strokeWidth="1" />
            <text x="78" y="22" textAnchor="middle" fontFamily="'JetBrains Mono', monospace"
              fill="#8a8479" fontSize="10" letterSpacing="1.6" fontWeight="600">START</text>
            <text x="78" y="42" textAnchor="middle" fontFamily="'Fraunces', Georgia, serif"
              fontSize="15" fill="#e8e3d6" fontWeight="500">Indian MAA filed</text>
          </AnimScale>
        </g>
        ...
        <motion.line
          ...
          stroke="#5dc8de" strokeWidth="1" strokeDasharray="2 3" strokeOpacity="0.5"
        ...
        <g transform="translate(310, 118)">
          <AnimSlideY delay={D.pivotLabel} reduced={r}>
            <rect x="-92" y="-11" width="184" height="22" rx="3"
              fill="#0f1011" stroke="#5dc8de" strokeWidth="1" />
            <text x="0" y="4" textAnchor="middle" fontFamily="'JetBrains Mono', monospace"
              fill="#5dc8de" fontSize="10" letterSpacing="1.6" fontWeight="600">
              AUG 2024 · DCGI ORDER
            </text>
          </AnimSlideY>
        </g>
        ...
        <motion.path {...drawPath(D.beforeBase)}
          ...
          stroke="#4a463e" strokeWidth="1" strokeDasharray="3 3" />
        <ArrowEnd x={210} y={55} color="#4a463e"
              ...
              {nextX && (
                <>
                  <motion.path {...drawPath(arrowPathDelay)}
                    ...
                    stroke="#4a463e" strokeWidth="1" strokeDasharray="3 3" />
                  <ArrowEnd x={nextX} y={55} color="#4a463e"
        ...
        <motion.path {...drawPath(D.beforeFinal, 0.4)}
          ...
          stroke="#4a463e" strokeWidth="1" strokeDasharray="3 3" />
        <ArrowEnd x={1060} y={102} color="#4a463e"
        ...
        <g transform="translate(1060, 74)">
          <AnimScale delay={D.outcome} reduced={r} cx={58} cy={30}>
            <rect x="0" y="0" width="115" height="60" rx="4"
              fill="none" stroke="#e8e3d6" strokeWidth="1.5" />
            <text x="58" y="26" textAnchor="middle" fontFamily="'JetBrains Mono', monospace"
              fill="#8a8479" fontSize="10" letterSpacing="1.6" fontWeight="600">OUTCOME</text>
            <text x="58" y="46" textAnchor="middle" fontFamily="'Fraunces', Georgia, serif"
              fontSize="13" fill="#e8e3d6" fontWeight="500">Indian approval</text>
          </AnimScale>
        </g>
        ...
        <g transform="translate(1060, 74)">
          <motion.rect
            ...
            fill="none" stroke="#5dc8de" strokeWidth="1.5"
        ...
        <AnimFade delay={D.afterLabel} reduced={r}>
          <text x="200" y="232"
            fontFamily="'JetBrains Mono', monospace" fontSize="11"
            fill="#5dc8de" letterSpacing="1.6" fontWeight="500">
        ...
        <motion.path {...drawPath(D.afterBase - 0.1)}
          ...
          stroke="#5dc8de" strokeWidth="1.5" />
        <ArrowEnd x={210} y={180} color="#5dc8de"
              ...
              {nextX && (
                <>
                  <motion.path {...drawPath(arrowPathDelay)}
                    ...
                    stroke="#5dc8de" strokeWidth="1.5" />
                  <ArrowEnd x={nextX} y={180} color="#5dc8de"
                    delay={arrowDelay(arrowPathDelay)} fade={ARROW_FADE} reduced={r} />
                </>
              )}
            </React.Fragment>
        ...
        <motion.path {...drawPath(D.afterFinal, 0.4)}
          ...
          stroke="#5dc8de" strokeWidth="1.5" />
        <ArrowEnd x={1060} y={132} color="#5dc8de"
...
function FlowNode({ x, y, w, h, label, text, muted, cyan, delay, reduced }) {
  ...
  const fill = cyan ? 'rgba(93, 200, 222, 0.08)' : '#161719';
  const stroke = cyan ? 'rgba(93, 200, 222, 0.22)' : '#4a463e';
  const labelColor = cyan ? '#5dc8de' : '#6e6a5e';
  const textColor = muted ? '#a8a399' : '#e8e3d6';
  const hoverFill = cyan ? 'rgba(93, 200, 222, 0.14)' : 'rgba(22,23,25,0.6)';
  const cx = w / 2;
    ...
    >
      ...
      >
        <div
          ...
          style={{
            fontSize: 'clamp(0.68rem, min(1vw, 1.5vh), 0.88rem)',
        ...
        <motion.div
          ...
          style={{
            ...
            fontSize: 'clamp(0.62rem, min(0.9vw, 1.3vh), 0.82rem)',
            letterSpacing: '0.1em',
            color: 'var(--cyan)',
            fontWeight: 600,
          }}
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(6px, 0.8vw, 16px)' }}>
          {AGENCIES.map((a) => (
            ...
            >
              ...
              <span
                className="deck-mono"
                style={{ fontSize: 'clamp(0.6rem, min(0.85vw, 1.2vh), 0.78rem)', color: 'var(--cream-muted)' }}
              >
                ({a.abbr})
              </span>
            </span>
