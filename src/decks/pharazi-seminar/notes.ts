...
## Bridge
→ But the case ran under three simultaneous disruptions — the next sequence maps what AMB112529 absorbed.`,
...
→ Return to the current Q&A thread; do not advance through backup slides as a mini-talk.`,
  ...
  // ══════════════════════════════════════════════════════════════
  'cs4-divider': `## Spoken
Case 04 — ==AI/ML in Clinical Pharmacology==. ⏸ Personal research, on my own time. The discipline is the same as the first three cases. ==The foundation has advanced.==
...
Five published systems address ==slices== of the workflow. ⏸ Apollo-AI, pyDarwin, DeepPumas, PEARL, QSP-Copilot. ⏸ ==No card fills more than three of seven segments==. The end-to-end MIDD foundation is the gap. ⏸ Hold this comparison — slide 07 overturns it.

## Cues
- ⏱ 75 sec — name each card briefly, point to the coverage bar
- 🎚 Editorial; not adversarial — these are honest peers
- 🎯 Land on "slices, not foundation"
