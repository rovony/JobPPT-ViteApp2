...
A: To set the contract before the receipts. The discipline is the same as Cases 1–3; the foundation has advanced.`,
  'cs4-objective': `## Q1: ==Two audiences, one platform — really?==
**From:** Skeptical clinical pharmacologist or pharmacometrician
**Difficulty:** ★★★ · **Topic:** scope

A: Yes — by design. The left column is the regulatory primitive (defensibility, audit, M15 alignment, named human authority); the right column is the workflow foundation (typed state, deterministic tools, end-to-end coverage). Same platform, two views.
...
A: Apollo-AI is conceptual / ~5 agents, QCP-focused (Shahin et al. 2025, CTS). Useful for PopPK + PKPD + ER literature work; not an end-to-end MIDD foundation.
...
A: Each owns one slice — pyDarwin (PopPK structural search), DeepPumas (model foundation), PEARL (regulatory RAG), QSP-Copilot (QSP modeling). None covers more than three of seven workflow segments. The visual claim is the contrast.`,
