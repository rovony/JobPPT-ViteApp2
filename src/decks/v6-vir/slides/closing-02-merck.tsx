 ...
 * CONCLUSION · Slide 02
 *
 * Repurposed from "Merck fit" to a Vir fit close.
 * Summarizes the three main case studies (PAH, ADC, AI Infrastructure)
...
const PRINCIPLES = [
  ...
  },
  {
    n: '02',
    color: 'var(--cyan)',
    label: 'ADC · MULTI-ANALYTE PK',
    icon: Globe2,
    headline: 'Modality complexity.',
    body: 'Turning conjugate, total antibody, payload, safety, and efficacy evidence into one dose rationale.',
  },
  {
    n: '03',
    color: 'var(--violet)',
