...
export default function Cs3AiRegulatoryFloor() {
  return (
    <AiEvidenceSlide
      eyebrow="Case 03 · regulatory floor"
      headline={<>AI is useful in clinical pharmacology only when the workflow can be <span style={{ color: 'var(--violet)', fontStyle: 'italic' }}>reviewed.</span></>}
