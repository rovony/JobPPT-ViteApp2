    ...
    >
      <svg viewBox={`0 0 ${W} ${H}`} style={{ width: '100%', height: 'auto' }} aria-label="Enrollment projection chart">
        ...
        <line
          ...
          stroke="var(--teal)" strokeWidth={1} strokeDasharray="4 3" opacity={0.6}
        />
        <text
          x={W - pad.r + 2} y={targetY + 3}
          fill="var(--teal)" style={{ fontSize: 8, fontFamily: 'var(--font-mono)', fontWeight: 700 }}
        >
          94
        </text>
            ...
            >
              ...
              <rect
                ...
                fill={i === 0
                  ...
                  : `color-mix(in srgb, var(--teal) ${Math.max(15, 50 - i * 12)}%, transparent)`
                }
                stroke="var(--teal)"
              ...
              {i < FUNNEL_STAGES.length - 1 && (
                <line
                  ...
                  stroke="var(--teal)" strokeWidth={1} opacity={0.3}
                  markerEnd="none"
                />
              )}
            </motion.g>
