...
export default function Cs3AiPoppkDashboard() {
  return (
    <AiEvidenceSlide
      eyebrow="Case 03 · PopPK dashboard"
      headline={<>A dashboard is valuable only if it makes model review <span style={{ color: 'var(--violet)', fontStyle: 'italic' }}>faster and safer.</span></>}
