...
A: They are the four I chose to make the Xencor story inspectable, not a taxonomy of every clin pharm problem. Untrialable, sample-limited, local-evidence, and unbuilt infrastructure cover the cases I will show. Other constraints exist — assay ambiguity, masked exposure, combination durability — and I address some of those in the Xencor bridge.
...
A: No. Unbuilt means the review infrastructure has not caught up to generation speed. Pharazi is personal research demonstrating how I think about traceability — not a procurement pitch to Xencor.
