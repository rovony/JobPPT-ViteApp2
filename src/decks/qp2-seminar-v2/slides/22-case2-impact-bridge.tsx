...
/* Bridge to CS3 — restructured as a two-row scaffold so the themes
 * row (4 items) gets a real line, and the next-case CTA gets its own
 * editorial line instead of being squeezed into 49px next to themes. */
function BridgeScaffold() {
  return (
    ...
    >
      {/* Row 1 — themes exercised, with a labeled rail and 4 chips */}
      <div
        style={{
          display: 'grid',
      ...
      >
        ...
        >
          <ThemeChip>Mechanism &gt; population</ThemeChip>
          <ThemeChip>Reframing &gt; defending</ThemeChip>
          <ThemeChip>Convergence of independent evidence</ThemeChip>
          <ThemeChip>Regulatory architecture as deliverable</ThemeChip>
        </div>
      </div>

      {/* Row 2 — next case CTA, full editorial line, hairline-cued */}
      <div
        style={{
          display: 'grid',
