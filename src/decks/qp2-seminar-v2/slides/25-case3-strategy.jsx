...
function Slab({ polys, tone = 0.2, edge = 0.6, children, initial, animate, transition, scale }) {
  ...
  return (
    ...
    >
      <polygon points={polys.side} fill="var(--violet)" fillOpacity={tone * 0.55} stroke="var(--violet)" strokeOpacity={edge * 0.6} strokeWidth={1} />
      <polygon points={polys.front} fill="var(--violet)" fillOpacity={tone * 0.85} stroke="var(--violet)" strokeOpacity={edge} strokeWidth={1.2} />
      <polygon points={polys.top} fill="var(--violet)" fillOpacity={tone} stroke="var(--violet)" strokeOpacity={edge * 0.9} strokeWidth={1} />
      {children}
    </motion.g>
  );
}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        ...
        >
          {data.title} ·{' '}
          <span style={{ color: 'var(--violet)', fontWeight: 700 }}>{data.n}</span>
        </span>
        <span
          style={{
            fontFamily: 'var(--font-body)',
