...
export default function Slide08cCaseStrategyVisuals() {
  ...
  return (
    <SlideFrame
      ...
      eyebrow="CS1 · Strategy evidence — diagnostics by decision"
      headline={
        <>
      ...
      headlineMaxChars={34}
      subhead="Decision-level diagnostics that justify the architecture before trial-design specifics: anchor, constrain, then enforce parsimony."
      subheadMaxChars={70}
      footerKicker="Case 01 · Strategy evidence"
