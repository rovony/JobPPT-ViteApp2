 ...
 *   diagram from the same CRUK family; reusing it for CS3 in a different
 *   tint would read as "we recoloured the same picture" rather than as
 *   two distinct cases. Cell-level imagery for CS3 keeps the visual
 ...
 * (#BC95C4 · #C7EAFB · #EAE0EF) that sits inside the CS3 violet family,
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            inset: '-6%',
            background:
              'radial-gradient(ellipse at center, color-mix(in srgb, var(--violet) 22%, transparent) 0%, transparent 68%)',
            filter: 'blur(18px)',
            zIndex: 0,
          }}
        />
