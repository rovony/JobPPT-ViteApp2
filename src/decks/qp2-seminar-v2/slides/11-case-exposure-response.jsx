...
export default function Slide11CaseExposureResponse() {
  ...
  return (
    <SlideGrid dataCase="coral" areas={STANDARD_AREAS}>
      <Eyebrow color="var(--coral)" delay={D.chrome}>CS1 · Safety E–R — flat across the exposure range</Eyebrow>
      ...
      <Subhead delay={D.subhead} maxChars={72} size="lead">
        ...
        {' '}— medians track within a few percent · 35-&lt;50 kg subgroup safety closes the loop.
      </Subhead>
      ...
      <Viz>
        <div style={{ width: '100%', height: '100%', display: 'grid', gridTemplateRows: '1fr auto', rowGap: 'var(--space-4)', minHeight: 0 }}>
          ...
          */}
          ...
          {/* Probe inoculation — "is exposure-matching enough?"
              Closes the loop with S10's 35-<50 kg subgroup caveat.
              Pre-empts the hostile probe by stating the answer before it lands. */}
          <motion.div
            style={{
          ...
          >
            ...
            >
              Why exposure matching is sufficient
            </span>
            <span
              style={{
            ...
            >
              Flat E–R means dose isn't pushed for efficacy — the established adult threshold is the
              target. The model places every pediatric exposure inside that envelope, including the
              35–&lt;50 kg subgroup flagged on the previous slide.
            </span>
          </motion.div>
        </div>
      </Viz>
