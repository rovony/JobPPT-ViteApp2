    ...
    >
      ...
      <g data-el="hub">
        ...
        {/* Hub label — single centered line.
            Option A · DECISION → JUDGMENT. The seminar's spine
            ("when the model becomes the evidence") requires
            judgment, not just a decision: five questions converge
            here, and what comes out is the *judgment call* the
            program acts on. Matches the new S4 headline
            ("the same five judgments show up every time"). */}
        <text
          data-el="hub-primary"
          x={HUB.cx}
          y={HUB.cy + 12}
