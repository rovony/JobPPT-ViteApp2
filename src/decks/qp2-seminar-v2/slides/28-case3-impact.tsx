...
/**
 * Slide 28 · CS3 Impact — A 36% enrollment reduction.
 *
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ color: 'var(--violet)', fontWeight: 700 }}>60</span>{' '}
...
function PatientGrid({ delay, dimDelay, ease, reduce }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: 'var(--violet)', fontWeight: 700 }}>■ 60 enrolled</span>
    ...
    >
      <div
        ...
        style={{
          fontSize: 'var(--fs-card-label)',
          letterSpacing: 'var(--ls-mono-wide)',
          color: accent ? 'var(--violet)' : 'var(--cream-muted)',
          fontWeight: 700,
        }}
      >
        {kicker}
      ...
      <div
        ...
        style={{
          ...
          fontWeight: 700,
          color: accent ? 'var(--violet)' : 'var(--cream)',
