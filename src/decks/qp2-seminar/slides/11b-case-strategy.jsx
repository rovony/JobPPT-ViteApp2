  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Closing ribbon — styled to match slide 11 (case-challenge)
            ...
            layoutId pairs with slide 11's FocalQuestion so the
            advance from 11 → 11b morphs the question panel into the
            answer ribbon: same vessel, new content. The dimensions
            differ (question is taller; ribbon is wider/shorter), so
            framer-motion will animate the bbox shift smoothly. */}
        <motion.div
