...
export default function Slide19Case2Response() {
  return (
    <SlideFrame
      ...
      footerSource="Source · CDSCO 91-KB submission · 27 Mar 2025 SEC recommendation · CDSCO marketing authorization 14 May 2025"
    >
      <ResponseLayout />
    </SlideFrame>
  );
...
const STEPS = [
  { date: '27 Mar 2024', label: 'MAA filing',                detail: 'CDSCO Form 44' },
  { date: '23 May 2024', label: 'SEC #1',                    detail: 'Pre-clinical & efficacy' },
  { date: '23 Aug 2024', label: 'EO query',                  detail: 'Examiner Office batch 1' },
  { date: '10 Dec 2024', label: 'SEC #2 — objection',        detail: '"Conduct PK/PD study in Indian patients"', flag: 'turn' },
  { date: 'Dec — Jan',   label: 'Strategy reframe',          detail: 'Mechanism-first response', isPeriod: true },
  { date: '14 Jan 2025', label: '91-KB submission',          detail: '600-pg PK/PD package' },
  { date: '27 Mar 2025', label: 'SEC #3 — in-person',        detail: 'Single live presentation · 6 pillars · 9/9 ICH E5 criteria', flag: 'climax' },
  { date: 'Apr — May',   label: 'Approval cleared',          detail: 'Favorable rec → CDSCO MA · 14 May', isPeriod: true, periodStart: '4 Apr 2025', periodEnd: '14 May 2025' },
];
...
function parseStepDate(s) {
  ...
  return mi >= 0 ? new Date(parseInt(m[3], 10), mi, parseInt(m[1], 10)).getTime() : null;
}
