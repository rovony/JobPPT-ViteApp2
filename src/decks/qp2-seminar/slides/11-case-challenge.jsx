...
function FocalQuestion() {
  ...
  return (
    // layoutId pairs this amber question panel with slide 11b's
    // amber answer ribbon ("Each choice is a regulatory defense
    // before it's a statistical one"). When the user advances
    // 11 → 11b the panel literally morphs in place — the question
    // becomes the answer, same vessel, new content. Both are HTML
    // motion.divs with matching bg/border/radius so the morph is
    // clean (no SVG ↔ HTML bbox approximation).
    <motion.div
      layoutId="cs1-focal-amber"
      style={{
        display: 'flex',
        alignItems: 'center',
        gap: 'var(--space-4)',
