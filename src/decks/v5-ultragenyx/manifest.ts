...
const manifest = {
  id: 'v5-ultragenyx',
  title: "When the trial can't answer",
  subtitle: 'Three cases where clinical pharmacology closed the gap',
  theme: 'clinical',
  notes,
  qa,
  reading,
  ...
  standardLayout: {
    ...
    footer: {
      line: true,
      text: "When the trial can't answer · Spring 2026",
  ...
  slides: [
    ...
    // CS 2 — Pharos source. Old pharazi-derived slots dropped 2026-05-06.
    { id: 'cs2-pharazi-divider', title: 'Case 02 · AI the Pharazi', component: CS2PharaziDivider, isTitle: true, transition: 'fade', time: 30 },
    { id: 'cs2-regulatory-floor', title: 'CS2 · Regulatory floor', component: PharosRegulatoryFloorSlide, isTitle: false, time: 40 },
    { id: 'cs2-market-moving', title: 'CS2 · Comparator landscape', component: PharosMarketMovingSlide, isTitle: false, time: 40 },
    { id: 'cs2-gap', title: 'CS2 · The MIDD foundation is unbuilt', component: PharosGapSlide, isTitle: false, time: 40 },
    { id: 'cs2-transition', title: 'CS2 · Movement II marker', component: PharosTransitionSlide, isTitle: true, time: 30 },
    { id: 'cs2-principle1', title: 'CS2 · P1 · Centralized hierarchy', component: PharosPrinciple1Slide, isTitle: false, time: 45 },
    { id: 'cs2-principle2', title: 'CS2 · P2 · Structural privacy', component: PharosPrinciple2Slide, isTitle: false, time: 45 },
    { id: 'cs2-principle3', title: 'CS2 · P3 · Cryptographic audit', component: PharosPrinciple3Slide, isTitle: false, time: 45 },
    { id: 'cs2-principle4', title: 'CS2 · P4 · SOPs as versioned plans', component: PharosPrinciple4Slide, isTitle: false, time: 45 },
    { id: 'cs2-principle5', title: 'CS2 · P5 · Orthogonal layering', component: PharosPrinciple5Slide, isTitle: false, time: 45 },
    { id: 'cs2-m3-begins', title: 'CS2 · Movement III marker', component: PharosM3BeginsSlide, isTitle: true, time: 20 },
    { id: 'cs2-working-overview', title: 'CS2 · Working system · overview', component: PharosWorkingOverviewSlide, isTitle: false, time: 45 },
    { id: 'cs2-working-audit', title: 'CS2 · Working system · QC + audit', component: PharosWorkingAuditSlide, isTitle: false, time: 40 },
    { id: 'cs2-component-nca', title: 'CS2 · Component · NCA', component: PharosNCAComponent, isTitle: false, time: 35 },
    { id: 'cs2-component-dataflow', title: 'CS2 · Component · Data flow', component: PharosDataFlowComponent, isTitle: false, time: 35 },
    { id: 'cs2-component-audit', title: 'CS2 · Component · Audit chain', component: PharosAuditChainComponent, isTitle: false, time: 35 },
    { id: 'cs2-poppk-dashboard', title: 'CS2 · PopPK dashboard', component: PharosPopPKDashboard, isTitle: false, time: 35 },
    { id: 'cs2-component-sop', title: 'CS2 · Component · Marketplace SOP', component: PharosMarketplaceSOPComponent, isTitle: false, time: 35 },
    { id: 'cs2-regulatory-dashboard', title: 'CS2 · Regulatory readiness dashboard', component: PharosRegulatoryDashboard, isTitle: false, time: 35 },
    { id: 'cs2-e2e-audit', title: 'CS2 · End-to-end audit dashboard', component: PharosE2EAuditDashboard, isTitle: false, time: 40 },
    { id: 'cs2-synthesis-dossier', title: 'CS2 · Synthesis · interactive dossier', component: PharosSynthesisDossier, isTitle: false, time: 50 },
    { id: 'cs2-synthesis-trace', title: 'CS2 · Synthesis · cinematic workflow trace', component: PharosSynthesisTrace, isTitle: false, time: 50 },
    { id: 'cs2-publication-close', title: 'CS2 · Publication close · pharazi.ai', component: PharosPublicationClose, isTitle: false, time: 30 },
    { id: 'cs2-interactive-dossier', title: 'CS2 · Interactive dossier · PharmAgent demo', component: CS2InteractiveDossier, isTitle: false, time: 60 },

    // CS 3 - India (Ivosidenib)
    { id: 'cs3-ivosidenib-divider', title: 'Case 03 · Ivosidenib', component: CS3IvosidenibDivider, isTitle: true, time: 60 },
    { id: 'cs3-bg-disease', title: 'CS3 · 42 countries', component: CS2BackgroundDisease, isTitle: false, time: 70 },
    { id: 'cs3-disease', title: 'CS3 · Disease', component: CS2DiseaseBackground, isTitle: false, time: 70 },
    { id: 'cs3-competitors', title: 'CS3 · Landscape', component: CS2Competitors, isTitle: false, time: 70 },
    { id: 'cs3-bg-regulatory', title: 'CS3 · Rule 101', component: CS2BackgroundRegulatory, isTitle: false, time: 80 },
    { id: 'cs3-setup', title: 'CS3 · Can dossier replace local trial?', component: CS2Setup, isTitle: false, time: 80 },
    { id: 'cs3-architecture-v2', title: 'CS3 · MOA', component: CS2ArchitectureV2, isTitle: false, time: 85 },
    { id: 'cs3-pillars', title: 'CS3 · Six pillars', component: CS2Pillars, isTitle: false, time: 100 },
    { id: 'cs3-reversal', title: 'CS3 · CDSCO approved', component: CS2Reversal, isTitle: false, time: 80 },
    { id: 'cs3-reckoning', title: 'CS3 · What we shipped', component: CS2Reckoning, isTitle: false, time: 70 },
    { id: 'cs3-leadership', title: 'CS3 · Bracket Method ownership', component: CS2Leadership, isTitle: false, time: 75 },
    { id: 'cs3-bridge-recap', title: 'CS3 · The science was the bridge', component: CS2BridgeRecap, isTitle: false, time: 60 },
