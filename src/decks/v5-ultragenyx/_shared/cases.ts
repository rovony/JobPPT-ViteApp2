...
export const CASES = [
  ...
  {
    id: 2,
    label: 'CASE 02 · AI / ML · CLIN PHARM AGENT',
    title: 'Agent architecture for regulated pharmacology workflows.',
    note: 'Research platform, 2026.',
    color: 'var(--cyan)',
    dotX: 495,
    dotY: 118,
    labelX: 555,
  ...
  {
    id: 3,
    label: 'CASE 03 · IVOSIDENIB · INDIA AML',
