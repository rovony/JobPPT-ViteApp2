...
export function AiBackupDivider() {
  return (
    <BackupGroupDivider
      ...
      subhead="The live Xencor story uses only the regulatory floor, gap, working overview, PopPK dashboard, and publication close. The rest stays available for deeper technical discussion."
      label="Backup · AI"
...
export function IvosidenibBackupDivider() {
  return (
    <BackupGroupDivider
      ...
      subhead="These slides are preserved as supporting evidence for global-to-local reliance and regulatory dossier strategy, but they are not part of the Xencor main flow."
