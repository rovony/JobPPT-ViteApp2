...
All **49 live slides** now have v7-xencor-v2 overrides in `override-notes.ts`. Read the **Spoken** section aloud — it is full sentences. **Cues** are delivery reminders only (timing, pointing, guardrails). **Off-slide** is Q&A depth not on screen.
