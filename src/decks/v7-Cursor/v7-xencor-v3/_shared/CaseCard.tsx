...
/**
 * CaseCard — shared case preview card (roadmap / optional hook morphs).
 * Title slide 01 is a minimal cover and no longer renders this component.
 * layoutId="hook-mark-csN" remains available if a later slide remounts
 * these cards for a FLIP morph.
 *
 * Props:
