...
A: It is an operating sequence for decisions under incomplete evidence, not a methods slogan. Define locks the decision and the cost of being wrong before any model is chosen. Challenge forces a competing explanation and a failure condition into the open. Test picks the evidence architecture the available data can actually support. Act takes the pre-agreed branch and keeps the limitation visible — that last part is what turns analysis into a repeatable function.

> **Move-forward:** same order every case; method changes.

## Q2: Why not put the four case constraints on this slide?
...
## Q2: What transfers to Xencor oncology trials?
**From:** Xencor hiring manager
...
> **Anchor:** outcome on public record.`,
  ...
  'cs3-bridge-recap': `## Q1: What is the one lesson you want from India for Xencor?
**From:** panel chair
**Difficulty:** ★★ · **Topic:** transfer

A: When local measurement is infeasible or unnecessary, a rigorous clinical pharmacology dossier can be the bridge — if mechanism, PK, exposure-response, and transparency converge. That is the same dose-defense instinct Xencor needs in oncology and infectious disease, even when the disease changes.
...
A: The four cases are the proof core. This beat lets the panel absorb that the evidentiary work is complete before we widen to portfolio breadth and the Xencor bridge. It prevents the talk from feeling like a continuous catalog.
...
**From:** Xencor program lead
**Difficulty:** ★★★★★ · **Topic:** Xencor humility
...
> **Move-forward:** That is the common thread across the four cases and the Xencor bridge.`,
...
A: Whichever case best tests the role you care about — pediatric extrapolation, efficient design, India reliance, AI governance, or Xencor bridge fit. I can go deep on any of them using backups; the four-case spine is the map.
