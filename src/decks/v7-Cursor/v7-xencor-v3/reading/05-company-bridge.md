...
The company bridge is a neutral implementation surface with Xencor-specific copy.
It should stay reusable for future company decks: slide IDs use
`company-bridge-*`, and the Xencor-specific language lives in the bridge content
module.

Presenter guardrail:

- Do not claim direct Xencor program access.
- Present VIR-5500 / PRO-XTEN thinking as a public-information hypothesis.
- Lead with Xencor's dose questions — not a credentials recap.
