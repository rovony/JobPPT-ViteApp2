...
import {
  ...
  LayoutGrid, LayoutList, ArrowUpDown, Plus, Trash2, Pencil,
  Heart, ArchiveRestore, GripVertical, Folder, ChevronRight,
...
/* ================================================================
   ...
   ================================================================ */
function DeckListRow({ deck, index, themeMode, onOpenSources }) {
  const { state, dispatch } = useOrganizer();
  const meta = state.deckMeta[deck.id] || {};
  const display = useDeckDisplay(deck);
  const [ctxMenu, setCtxMenu] = useState(null);
