 ...
 *
 * Both parsers are TOLERANT — if the input doesn't match the spec,
 ...
 *
 * Structured notes render when `## Spoken` (and optional `## Cues` /
 * `## Bridge`) is present. Presenter “View” toggles (see
 * `useNotesSectionVisibility`) only change which blocks display.
 */
