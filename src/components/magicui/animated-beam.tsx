// @ts-nocheck
// Source: magicui.design/docs/components/animated-beam — MIT-licensed, copy-paste.
// Trimmed to essentials for showcase. Renders an animated SVG path between two refs.
