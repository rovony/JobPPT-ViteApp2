...
import { Sparkles, Send, Loader2, Lightbulb, Mic, Square, FolderOpen, BookOpen, Globe, StickyNote, Settings, Cpu, AlertTriangle, Database, ChevronDown, ChevronRight, Zap, GraduationCap, Bug, Trash2 } from 'lucide-react';
...
export default function PresenterAssistant({ deck, currentSlide, currentNote, onOpenSources }) {
  ...
  return (
    ...
    >
      ...
      {/* Messages — min-h-0 + flex so empty state can vertically center in the
          full height of the assistant body (not stuck at the top of a tall void). */}
      <div
        ref={listRef}
        ...
        {messages.length === 0 && (
          <div className="flex-1 flex flex-col justify-center w-full min-h-0">
            <div className="space-y-3 w-full max-w-full">
              ...
              <div
                className="pt-2 deck-mono uppercase flex items-center gap-1.5"
