...
const READING_MARK = { markClass: 'reading-mark' };

const readingMarkdownComponents = {
  h1: ({ node, children, ...p }) => <h1 className="reading-h1" {...p}>{transformNotesInlineChildren(children, READING_MARK)}</h1>,
  h2: ({ node, children, ...p }) => <h2 className="reading-h2" {...p}>{transformNotesInlineChildren(children, READING_MARK)}</h2>,
  h3: ({ node, children, ...p }) => <h3 className="reading-h3" {...p}>{transformNotesInlineChildren(children, READING_MARK)}</h3>,
  p:  ({ node, children, ...p }) => <p  className="reading-p"  {...p}>{transformNotesInlineChildren(children, READING_MARK)}</p>,
  ul: ({ node, ...p }) => <ul className="reading-ul" {...p} />,
  ol: ({ node, ...p }) => <ol className="reading-ol" {...p} />,
  li: ({ node, children, ...p }) => <li className="reading-li" {...p}>{transformNotesInlineChildren(children, READING_MARK)}</li>,
  strong: ({ node, children, ...p }) => <strong className="reading-strong" {...p}>{transformNotesInlineChildren(children, READING_MARK)}</strong>,
  em:     ({ node, children, ...p }) => <em className="reading-em" {...p}>{transformNotesInlineChildren(children, READING_MARK)}</em>,
