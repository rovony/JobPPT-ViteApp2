    ...
    <SlideGrid dataCase="violet" areas={STANDARD_AREAS}>
      ...
      <Viz>
        ...
        >
          ...
          >
            {/* Waterfall — wrapped in hairline panel (zaj-slides v2.1) so
                the chart isn't naked next to the bordered PillarStatus
                cards on the right. Square corners (rounded card chrome
                is banned per craft-bans skill). */}
            <div
              style={{
                display: 'grid',
